# Chapter 9: The Neural Layer — Memory, Feedback, and Internal Models
...
## 9.1 Neural Manifestations of $\Psi$, $\Phi$, and $\Omega$
...
## 9.2 Neural Structures as Reusable Memory Units
...
### 9.3.1 Comparative Neural Complexity
...
### 9.4.2 Internal Models and Prediction
...
This is not merely an update rule. It is **gradient ascent on the emergence potential** $P(\Phi)$ viewed as a Lyapunov function over the neural lattice (Theorem 6, Appendix M). A learning brain is climbing a landscape — synaptic weights flow toward configurations that produce more coherent predictions of the world. Hebbian plasticity, error-correction in the cerebellum, and predictive coding in the cortex are all instances of the same gradient flow, just operating on different substrates within $\Omega^{\text{neural}}$.

These predictive models include:
...
## 9.5 Entropy Reduction in Neural Processing
...
## 9.6 Proto-Consciousness: Self-Referential Models
...
## 9.7 The Emergent Properties of Neural Systems
...
## 9.8 Computational Principles in Neural Processing
...
## 9.9 Transition to the Cognitive Layer
...
## 9.10 Threshold of Recursive Cognition
...
### 9.10.1 The Cognitive Ignition Point
...
### 9.10.2 Visualizing the Transition
...
### 9.10.3 Predictive Signatures of Cognitive Emergence
